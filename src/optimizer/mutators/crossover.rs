...
mod tests {
    ...
    fn test_crossover() {
        ...
        let current_sequence: Solution<crate::common::bin_box::BinBox> = Solution::new(vec![0, 1, 2, 3, 4], 0.0, vec![]);
        let second: Solution<crate::common::bin_box::BinBox> = Solution::new(vec![4, 3, 2, 1, 0], 0.0, vec![]);
